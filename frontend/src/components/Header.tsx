    ...
    <div className={styles.container}>
        <div className={styles.containerContact}>
            ...
            <div className={styles.socialMedia}>
                <a href="https://x.com/" target="_blank"><FaTwitter className={styles.icon}/></a>
                <a href="https://www.linkedin.com/" target="_blank"><FaLinkedinIn className={styles.icon}/></a>
                <a href="https://www.google.com/" target="_blank"><FaGoogle className={styles.icon}/></a>
                <a href="https://br.pinterest.com/" target="_blank"><FaPinterestP className={styles.icon}/></a>
